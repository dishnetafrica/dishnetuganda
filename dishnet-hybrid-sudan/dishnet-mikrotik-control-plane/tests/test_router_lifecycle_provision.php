...
// ===========================================================================
t('10. REPOSITORY STATE — 028 is followed by 029 (O-1, docs/124), 030 (onboarding, docs/125) and 031 (sign-in, docs/127); the ledger agrees; nothing claims hardware');
$files = array_map('basename', glob($root . '/migrations/*.sql')); sort($files);
is_(array_slice($files, -4), ['028_admin_router_lifecycle_and_provisioning.sql', '029_o1_site_service_same_operator.sql', '030_admin_operator_onboarding.sql', '031_sign_in_requires_active_operator.sql'],
    '028 is followed by 029 (O-1, docs/124), 030 (onboarding, docs/125) and 031 (sign-in, docs/127)');
is_((int) $ins->one('SELECT count(*)::int n FROM mt_migrations')['n'], 31, 'the ledger records 31');
