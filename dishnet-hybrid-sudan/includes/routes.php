...
// 5.18.37: the ?page=crm_debug page is gone. It listed uCRM payment methods,
// created (and deleted) a 0.01 payment on a client and replayed the payment
// retry queue — with no login of any kind. tools/crm_debug.php does the same
// from the command line, for an operator who is already on the server.
